                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    MultiSelectDialogField(
                      ...
                      validator: null,
                      initialValue: habit.map((e) => e.toString()).toList(),
                    ...
                    Center(child: Buttons.actionButtons(title: 'Save', event: () async {
                      if(formKey.currentState!.validate()){
                        ...
                        await customerController.editCustomer(email, updatedCustomer);
                      }
                    })),
